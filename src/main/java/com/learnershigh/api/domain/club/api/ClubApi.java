package com.learnershigh.api.domain.club.api;

import com.learnershigh.api.domain.club.application.impl.ClubServiceImpl;
...
public class ClubApi {
	...
	@PostMapping("/club")
	public ResponseEntity<StandardResponseBody> createClub(
		ClubCreateRequestDto clubCreateRequestDto) throws DuplicatedClubNameException, IOException, NullPointerException {
